...
export default function ForgotPasswordModal({ email, onEmailChange, onClose }: ForgotPasswordModalProps) {
      ...
      <div className="modal-container">
        {!isEmailSent ? (
            ...
            <form className="password-modal__form" onSubmit={handleSubmit}>
              <div className="password-modal__form-group">
                ...
                <input
                  type="email"
                  id="recovery-email"
                  className={`password-modal__input ${emailError ? "password-modal__input--error" : ""}`}
                  ...
                  disabled={isLoading}
                />
                {emailError && <span className="password-modal__error">{emailError}</span>}
              </div>

              <button type="submit" className="password-modal__button" disabled={isLoading}>
                {isLoading ? (
          ...
          <div className="password-modal">
            ...
            <button type="button" className="password-modal__button" onClick={onClose}>
              Back to login
            </button>
          </div>
        )}
